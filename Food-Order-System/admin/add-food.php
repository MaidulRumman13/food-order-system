    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if (isset($_POST['submit']))
            {
                ...
                //Check  radio button for feature and active are checked or not
                ...
                {
                    $feature = "No"; //SEtting the Default Value
                }
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    //Check the Image is Selected or not and upload image only if selected
                    if($image_name!="")
                    {
                        // Image is SElected
                        //A. REnamge the Image
                        ...
                        $image_name = "Food-Name-".rand(0000,9999).".".$ext; //as like "Food-Name-657.jpg"
                ...
                else
                {
                    ...
                    $_SESSION['add'] = "<div class='error'>Failed to Add Food Or This Food Already Added.</div>";
                    header('location:'.SITEURL.'admin/add-food.php');
                }
            }
